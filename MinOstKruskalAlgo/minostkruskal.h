...
#ifndef MINOSTKRUSKAL_H
#define MINOSTKRUSKAL_H

#include "minostkruskal_global.h"
#include "AlgoPlugins/algopluginloader.h"
#include "AlgoPlugins/sleep.h"

class MINOSTKRUSKALSHARED_EXPORT MinOstKruskal: public QObject, AlgoInterface{
	Q_OBJECT
...
public slots:
	virtual bool run(AbstractGraph *gr, int);
	virtual void stop();
